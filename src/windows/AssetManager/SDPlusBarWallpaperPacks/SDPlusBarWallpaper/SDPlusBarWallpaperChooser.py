...
class SDPlusBarWallpaperChooserPage(ChooserPage):
    def __init__(self, asset_manager: "AssetManager"):
        ...
        self.wallpaper_flow: SDPlusBarWallpaperFlowBox = None
        self._pending_pack: "SDPlusBarWallpaperPack" = None
    ...
    def build(self):
        ...
        # The flow box constructs a page's worth of SDPlusBarWallpaperPreviews
        # in its constructor -- GTK widgets, so the whole construction runs on
        # the main loop. Building it on this worker thread was the off-main
